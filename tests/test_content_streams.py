...
@pytest.mark.asyncio
async def test_encode_response_empty_content():
...
@pytest.mark.asyncio
async def test_encode_response_bytes_content():
...
@pytest.mark.asyncio
async def test_encode_response_iterator_content():
    def hello_world():
        yield b"Hello, "
        yield b"world!"
...
@pytest.mark.asyncio
async def test_encode_response_aiterator_content():
    async def hello_world():
        yield b"Hello, "
        yield b"world!"
...
def test_encode_response_invalid_argument():
    with pytest.raises(TypeError):
